...
func (m *MockJWTGenerator) GenerateJWT(login string) (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockJWTGeneratorMockRecorder) GenerateJWT(login interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GenerateJWT", reflect.TypeOf((*MockJWTGenerator)(nil).GenerateJWT), login)
}
